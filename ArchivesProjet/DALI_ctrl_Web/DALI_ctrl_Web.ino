      ...
      while (client.connected() && currentTime - previousTime <= timeoutTime) { // loop while the client's connected
        ...
        if (client.available()) {             // if there's bytes to read from the client,
          ...
          if (c == '\n') {                    // if the byte is a newline character
            ...
            else if (header.indexOf("GET /setPowerOn") >= 0) {//---------------------------------------------------------------------------------j'en étais là
              
              // Récupère la valeur de l'input "powerOn"
              //String powerOnValue = server.arg("powerOn");

              // Convertit la valeur en entier
              //int powerOnLevel = powerOnValue.toInt();
              //powerOnLevel = document.getElementById("powerOn").value;
              Serial.print("Power On Level ");
              //Serial.println(powerOnLevel);
              //SetPowerOnLevel(powerOnLevel);
            }
            ...
            //LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
              ...
              client.println("<html>");
                ...
                client.println("body {border-width:2px;border:1rem solid;border-color:#141b6b;margin:5% 15% 5% 15%;border-radius: 25px;} ");
                  ...
                  client.println("<h2>");
                    ...
                    client.println("<d1>");
                        ...
                        client.println("<e1>");
                        	client.println("<c2>");
                              ...
                              client.println("<input type=\"number\" placeholder=\"0 - 999\" id=\"powerOn\" name=\"powerOn\"min=\"0\" max=\"999\">");
                              
                            
                              //PowerOn Button     
                                client.println("<a href=\"/setPowerOn\"><button class=\"button\">SET</button></a>");
                			    client.println("</c2>");
                          client.println("<c2>");
                    ...
                    client.println("<d1>");
                      client.println("<subtitle>Special Mods</subtitle>");
                        client.println("<c1>");
                				  client.println("<txt>Gradient 1min</txt>");
                            //Gradient Button     
                            client.println("<a href=\"/grad\"><button class=\"button\">START</button></a>");
                			  client.println("</c1>");
                	  client.println("	</d1>");

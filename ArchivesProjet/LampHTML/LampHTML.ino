          ...
          if (c == '\n') {                    // if the byte is a newline character
            ...
            //state equalization
              ...
              client.println("<html>");
                ...
                client.println("d2{display:flex;justify-content: center;}");
                client.println("d3{border-width:1px;border:solid;border-color:#141b6b;margin:1% 1% 1% 1%;border-radius: 5px;display:grid;background-color:#ffffff;width:50%}");
                ...
                client.println("<body>");
                  ...
                  client.println("<h2>");
                    ...
                    client.println("<d1>");
                				   client.println("<txt>Lamp is</txt>");
                    ...
                    client.println("<d2>");
                      client.println("<d3>");
                	      client.println("<subtitle>Time Settings</subtitle>");
                        client.println("<c1>");
                          client.println("<txt>Time Zone</txt>");
								          client.println("<input type=\"number\" placeholder=\"UTC\" id=\"utc\" name=\"utc\"min=\"0\" max=\"24\">");
                    	  client.println("</c1>");
                        client.println("<c1>");
								          client.println("<input type=\"text\" placeholder=\"Day\" id=\"day\" name=\"day\">");
                          client.println("<input type=\"number\" placeholder=\"Month\" id=\"month\" name=\"month\"min=\"1\" max=\"12\">");
                          client.println("<input type=\"number\" placeholder=\"Year\" id=\"year\" name=\"year\"min=\"2020\" max=\"2300\">");
                    	  client.println("</c1>");
                        client.println("<c1>");
								          client.println("<input type=\"number\" placeholder=\"Hour\" id=\"hour\" name=\"hour\"min=\"0\" max=\"23\">");
                          client.println("<input type=\"number\" placeholder=\"Minute\" id=\"minute\" name=\"minute\"min=\"0\" max=\"59\">");
                          client.println("<input type=\"number\" placeholder=\"Second\" id=\"second\" name=\"second\"min=\"0\" max=\"59\">");
                    	  client.println("</c1>");
                	    client.println("</d3>");
                    
                      client.println("<d3>");
                	      client.println("<subtitle>Location Settings</subtitle>");
                        client.println("<c1>");
                          client.println("<txt>Latitude</txt>");
								          client.println("<input type=\"number\" placeholder=\"Latitude\" id=\"latitude\" name=\"latitude\"min=\"0\" max=\"24\">");
                    	  client.println("</c1>");
                        client.println("<c1>");
                          client.println("<txt>Longitude</txt>");
								          client.println("<input type=\"number\" placeholder=\"Longitude\" id=\"longitude\" name=\"longitude\"min=\"0\" max=\"24\">");
                    	  client.println("</c1>");
                      client.println("</d3>");
                	  client.println("</d2>");
